...
class Encoder_Counter(Node):
    ...
    def listener_callback(self, msg):
        ...
        print("Received Int32MultiArray: ", self.left_enc_new)
        ...
        if(self.left_enc_prev==0):
            ...
            if(self.left_enc_new==3):
                ...
                self.left_count=self.left_count+1
            elif(self.left_enc_new==2):#for testing purposes, not real case
                self.left_count=self.left_count+1
            ...
            if(self.left_enc_new==0):
                ...
                self.left_count=self.left_count+1
            elif(self.left_enc_new==1):#for testing purposes, not real case
                self.left_count=self.left_count+1
